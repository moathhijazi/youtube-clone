  ...
  <body>
    ...
    <header>
        <div class="user-details">
            <div class="dropdown">
                <button id="user"   data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="../../assets/images/users/youtube-1.png" alt="">
                </button>
               
                <ul class="dropdown-menu users" id = "list-dropdown-users" >
                  <li><a class="dropdown-item">
                    <img src="../../assets/images/users/youtube-1.png" alt="username">
                    <span>username</span>
                  </a></li>
                  <hr class="text-light">
                  ...
                  <li><a class="dropdown-item" href="#">
                    ...
                    <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" class="style-scope yt-icon" style="pointer-events: none; display: block; width: 30px; height: 100%;"><g class="style-scope yt-icon"><path d="M20,3v18H8v-1h11V4H8V3H20z M11.1,15.1l0.7,0.7l4.4-4.4l-4.4-4.4l-0.7,0.7l3.1,3.1H3v1h11.3L11.1,15.1z" class="style-scope yt-icon"></path></g></svg>
                    <span>Log out</span>
                </a></li>
                </ul>
              </div>
              <div class="dropdown">
               ...
               <button id="notification" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <ul class="dropdown-menu noti" id = "list-dropdown">
                    <li>
                        <p class="notify-title">Notification</p>
                    </li>
                    <hr class="text-light">
                    <li><a class="dropdown-item notify" href="#">
                        <img src="../../assets/images/icons/youtube.png" class="content-image" alt="channel-image">
                        <div class="notify-content"><p>test lashflahgljg</p></div>
                        <img class="channel-image" src="../../assets/images/icons/youtube.png" alt="content-image">
                    </a></li>
    ...
    <section class="video">
        <div class="media-father">
            ...
            <div class="video-details">
                ...
                <div class="channel">
                    ...
                    <div class="react d-flex flex-row-reverse">
                        <div class="liking d-flex justify-content-center">
                            <button class="like" onclick = " send_dislike()">
                                <i id="dislike-icon" class="fa-regular fa-thumbs-down"></i>
                                
                            </button>
                            <div class="vr"></div>
                            <button class="dis-like" onclick="send_like()">
                ...
                <div class="discreption">
                    <div class="video-component">
                        <span>20/03/2020 . 18K views</span>
                    </div>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptate ad voluptatibus autem inventore, illum laudantium officia hic consectetur deserunt ab!</p>
                </div>
                <div class="comments">
                    <div class="comments-count">
                        <small>150 comments</small>
                    </div>
                    <div class="my-comm">
                        
                        <img src="../../assets/images/users/youtube-1.png" alt="username">
                        <input id="comment-input" type="text" autocomplete="off" placeholder="Add comment ... " class="comment">
             
                        
                    </div>
                    <div id="tools" class="tools d-flex justify-content-start" style="width : 880px; position: relative; top : -30px ;">
                        <button class="btn btn-primary" id="btn-1" style="font-size: 12px; margin : 0 10px;">comment</button>
                        <button class="btn btn-light" id="btn-2" style="font-size: 12px;">cancel</button>
                    </div>
                    <div class="show-comments">
                        <div class="my-comm">
                            ...
                            <div class="d-flex flex-column align-items-end">
                                <span class="text-secondary my-2 font-weight-bold">username . 12d</span>
                                <h6 class="comment"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas.</h6>
                            </div>
                        </div>
                    </div>
        ...
        <div class="sugg-videos">
            <ul class="sugg">
                
                <li class="video-sug">
                    <img src="../../assets/images/icons/youtube.png" alt="video-sug">
                    <span class="timer">11:50</span>
                    <div class="details">
                        <span>title</span>
                        <span>channel name</span>
                        <span>13K views . 3d</span>
                    </div>
                </li>
            </ul>
        </div>
    </section>
    <script src="../../assets/js/video-event.js"></script>
    <script>
        check(false , true , false , true);
    </script>
    <script src="https://code.jquery.com/jquery-3.6.4.min.js" integrity="sha256-oP6HI9z1XaZNBrJURtCoUT5SUnxFr8s3BzRl+cbzUq8=" crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
    <script src="../../api/send/ajax.js"></script>
    </body>
</html>
