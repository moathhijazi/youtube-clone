  ...
  <body>
    ...
    <section class = "vali">
        <form method="post" enctype = "multipart/form-data">
            ...
            <div class= "video-border" id="bord">
                <p>Your video wil be here after uploaded</p>
            </div>
            <input type="file" id="video-input" name="video-source" class="form-control">

            <div class= "image-border" id="bord">
                <p>Your video image wil be here after uploaded</p>
            </div>
            <input type="file"  id="image-input" name="image-source" class="form-control">
    ...
    <script src="assets/js/upload-events.js"></script>
    </body>
</html>
